  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
    ...
    <div>
      ...
      <ul className="space-y-2">
        <li>📞 <a href="tel:+263774774865" className="text-[#5B6472] hover:text-[#F2601C]">+263 77 123 4567</a></li>
        <li>📞 <a href="tel:+263713165372" className="text-[#5B6472] hover:text-[#F2601C]">+263 71 234 5678</a></li>
      </ul>
      <div className="mt-4">
        <a
